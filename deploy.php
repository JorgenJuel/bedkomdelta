...
set('wp_path', '/home/1/d/deltahouse/www/bedkomdelta');
set('remote_path', '/home/1/d/deltahouse/www/bedkomdelta/wp-content/themes/bedkomdelta');
...
task('yarn', 'yarn run build')->local();
