...
class walker_texas_ranger extends Walker_Nav_Menu {
    ...
    function __construct($css_class_prefix) {
        ...
        $this->item_css_class_suffixes = array(
            'item'                      => '__punkt',  
            'parent_item'               => '__punkt--forelder',
            'active_item'               => '__punkt--aktiv',
            'parent_of_active_item'     => '__punkt--forelder--aktiv',
            'ancestor_of_active_item'   => '__punkt--stamfar--aktiv',
            'sub_menu'                  => '__undermeny',
            'sub_menu_item'             => '__undermeny__punkt',
            'link'                      => '__lenke',
        );
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $item_classes =  array(
            ...
            'depth_class'           => $depth >=1 ? $prefix . $suffix['sub_menu_item'] . ' ' . $prefix . $suffix['sub_menu'] . '--' . $depth . '__punkt' : '',
            'item_id_class'         => $prefix . '__punkt--'. $item->object_id,
            'user_class'            => $item->classes[0] !== '' ? $prefix . '__punkt--'. $item->classes[0] : ''
        );
